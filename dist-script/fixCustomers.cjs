...
async function runDataFix() {
    try {
        ...
        const shopsSnap = await (0, firestore_1.getDocs)((0, firestore_1.collection)(db, 'shops'));
        if (shopsSnap.empty) {
        ...
        for (const shopDoc of shopsSnap.docs) {
            ...
            const dailySnap = await (0, firestore_1.getDocs)((0, firestore_1.collection)(db, 'shops', shopId, 'daily'));
            const globalOrders = new Map();
            ...
            const customerSnap = await (0, firestore_1.getDocs)((0, firestore_1.collection)(db, 'shops', shopId, 'customers'));
            ...
            for (const custDoc of customerSnap.docs) {
                ...
                if (needsUpdate ||
                    ...
                    await (0, firestore_1.setDoc)((0, firestore_1.doc)(db, 'shops', shopId, 'customers', customer.id), updatedCustomer);
                    totalUpdated++;
                }
            }
